...
def is_correct(btn):
    ...
    if answer == parameters['correct'][-1]:
        ...
        widgets['question'][0].setText(str(parameters['question'][-1]))
        widgets['answer1'][0].setText(str(parameters['answer1'][-1]))
        widgets['answer2'][0].setText(str(parameters['answer2'][-1]))
        widgets['answer3'][0].setText(str(parameters['answer3'][-1]))
        widgets['answer4'][0].setText(str(parameters['answer4'][-1]))
...
def frame3():
    ...
    message.setStyleSheet(
        "font-family: 'verdana'; font-size: 25px; color: 'white'; margin: 100px 0px;"
        )
    ...
    message2.setStyleSheet(
        "font-family: 'verdana'; font-size: 30px; color: 'white'; margin-top:0px; margin-bottom:75px;"
        )
...
def frame4():
    ...
    message.setAlignment(QtCore.Qt.AlignRight)
    message.setStyleSheet(
        "font-family: 'verdana'; font-size: 35px; color: 'white'; margin: 75px 5px; padding:20px;"
        )
    widgets["message"].append(message)
